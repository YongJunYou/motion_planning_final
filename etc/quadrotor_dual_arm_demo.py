...
def setup_ros2_debug_publisher(robot, ee_body_ids, ee_names):
    ...
    print("        /manipulator/current/wrench")
    print("        /manipulator/current/ee_positions    # [left xyz, right xyz]")
    print("        /manipulator/current/joint_states")
    print("        /manipulator/current/joint_positions")
    return ros_pub
